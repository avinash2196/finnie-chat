...
def test_performance_history():
    ...
    if response.status_code == 200:
        ...
        print(f"\nâœ… Found {len(snapshots)} snapshots")
...
def test_market_quote():
    ...
    if response.status_code == 200:
        ...
        print(f"\nâœ… Retrieved {data.get('count', 0)} quotes:")
...
def test_screeners():
    ...
    for screener_type in screeners:
        print(f"\nðŸ“Š Testing {screener_type.upper()} Screener...")
        ...
        if response.status_code == 200:
            ...
            if 'opportunities' in data:
                print(f"   âœ… Found {len(data['opportunities'])} opportunities")
            elif 'stocks' in data:
                print(f"   âœ… Found {len(data['stocks'])} stocks")
            else:
                print(f"   âœ… Screener executed successfully")
        else:
            print(f"   âŒ Error: {response.text[:100]}")
...
def test_strategy_ideas():
    ...
    for risk in risk_levels:
        print(f"\nðŸ’¡ Testing {risk} Risk Strategies...")
