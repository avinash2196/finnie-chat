...
async def test_sync():
    ...
    try:
        ...
        print(f"\nðŸ“Š Before sync: {before_holdings} holdings, {before_txns} transactions")

        # Perform sync
        print("\nðŸ”„ Syncing with MOCK provider...")
        ...
        print(f"\nðŸ“Š After sync: {len(after_holdings)} holdings, {len(after_txns)} transactions")
        ...
        print(f"\nðŸ’° User portfolio value: ${test_user.portfolio_value:.2f}")
